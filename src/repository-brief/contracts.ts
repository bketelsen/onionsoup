...
export const BriefRequest = z.object({ schemaVersion: z.literal(1), repository: IssueSnapshot.shape.repository,
...
export const ThemeInput = z.object({ schemaVersion: z.literal(1), snapshotHash: z.string().regex(/^[a-f0-9]{64}$/),
  repository: IssueSnapshot.shape.repository, collection: z.enum(['issues','prs']),
