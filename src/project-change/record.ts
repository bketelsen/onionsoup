...
export type ProjectWorkflow={schemaVersion:1;kind:'project-change';workflowId:string;startedAt:string;finishedAt?:string;status:'running'|'completed'|'failed';
  parent:ProjectProposal;job:Job;runtime:Runtime;dependencies:Dependency;seedHash:string;baseline?:Verification;candidate?:Verification;after?:Files;headCommit?:string;headTree?:string;diff?:string;diffHash?:string;appliedTree?:string;
