...
const tests=await run(['--max-old-space-size=512','--import','/work/node_modules/tsx/dist/loader.mjs','--test','--test-concurrency=1','--test-reporter=tap',...input.testFiles]);
...
process.stdout.write(JSON.stringify({nonce:input.nonce,typecheck,tests,checks}));
