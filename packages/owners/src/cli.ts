...
const LOCK_FREE = ['items', 'show', 'notebook', 'requests', 'approve', 'revise-plan', 'reject', 'resume', 'desk', 'desk-state', 'retract', 'approve-push', 'approve-create', 'approve-delete', 'deny-request'];
try {
