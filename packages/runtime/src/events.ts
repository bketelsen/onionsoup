...
export const WorkflowEvent = z.object({
  ...
  type: z.enum(['workflow.started', 'workflow.completed', 'workflow.partial', 'workflow.failed', 'workflow.unfinished',
    ...
    'agent.result_rejected', 'agent.step_started', 'agent.step_finished', 'agent.tool_requested', 'stage.skipped', 'stage.failed',
  ...
  agent: z.enum(['workload-triage', 'bug-readiness', 'code-location', 'repository-themes','repository-health','maintenance-actions','feature-requirements','change-proposal','scoped-patch','change-review']).optional(), runId: Id.optional(), parentRunId: Id.optional(),
  ...
  rejectionReason: z.enum(['FINDING_PARTITION','INVALID_EVIDENCE','RECOVERY_NOT_ESTABLISHED','CURRENT_SIGNAL_NOT_ESTABLISHED','NEXT_INVESTIGATION_REQUIRED','UNSAFE_PROSE','INVALID_SCHEMA']).optional(),
