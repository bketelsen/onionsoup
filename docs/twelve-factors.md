...
built from shared contracts. It also proposes a second consumer to test that boundary.
...
This document and `skills/*/SKILL.md` adapt the source's ideas and are licensed
