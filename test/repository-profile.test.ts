...
import {RepositoryProfile,Task,VerificationPlan,validateTask,standardGoChecks} from '../src/project-change/repository-profile.ts';
...
const profile=RepositoryProfile.parse(await json('examples/repository-profiles/clippy.json'));
